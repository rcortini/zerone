...
pdf("~/Dropbox/figure.pdf", width=6, height=6)
...
lines(0:20+.15, ypois[1:21] / sum(y), type="h", lwd=3, col="red")
lines(0:20+.3, ynb[1:21] / sum(y), type="h", lwd=3, col="blue")
lines(0:20+.45, yzinb[1:21] / sum(y), type="h", lwd=3, col="seagreen3")
legend(legend=c("Observed", "Poisson", "NB", "ZINB"),
    x="topright", inset=0.04, lwd=3,
    col=c("black", "red", "blue", "seagreen3"), bg="white")
dev.off()
