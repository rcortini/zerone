...
we determined how the peaks were distributed around Transcription
Start Sites (TSS), as it is expected that most of the Pol2 signal
should contained annotated TSS.
