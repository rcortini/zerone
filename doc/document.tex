...
\caption{
  ...
  over the whole range. Source: ENCODE file wgEncodeSydhTfbsK562InputRawData.fastq
  from repository
...
Disretization amounts to finding the sequence of states and the
...
immuno-precipitation.  Thus, a total of 182 cases (91 positive and 91
...
data set on the cell line K562 (GEO accesion GSM1480325). 
...
is available from the associated Docker container.
...
classifier able to identify failed discretization
with 98.3\% accuracy (see section \ref{sub:training}).
...
the immuno-precipitation failed (Fig.~\ref{fig:jarid}).
