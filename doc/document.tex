...
Genomic windows are sorted by decreasing order of ChIP-seq reads and 
the cumulative read number is plotted. The curve is thus a Pareto front
\textit{i.e.} no discretizer can be on the left side of the curve.
