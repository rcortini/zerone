  ...
  \section{Results:}
    ...
    low quality profiles with 5\% of errors. We also introduce a graphical
...
\caption{
  ...
  %file wgEncodeSydhTfbsK562InputRawData.fastq.gz
  %from repository
...
Briefly, a number of pairwise IDR analyses are performed on the replicates,
as described in the IDR website
(\href{https://sites.google.com/site/anshulkundaje/projects/idr}
{https://sites.google.com/site/anshulkundaje/projects/idr}),
and experiments below a certain reproducibility score are flagged as faulty.
Zerone's quality control and this IDR-based method agreed in 85\% of the cases
(see associated Docker container).
It is important to note that, unless Zerone, this method can only be applied
on peaky profiles, and that it only detects low quality experiments based on
replicate consistency (and indirectly, coverage), ignoring other potential
sources or error such as the discretization process itself.
